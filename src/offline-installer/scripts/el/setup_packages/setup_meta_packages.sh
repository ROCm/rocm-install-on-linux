...
[amdgpu]
name=amdgpu
baseurl=https://repo.radeon.com/amdgpu/$AMDGPU_VERSION/el/$version_id_mapped/main/x86_64/
enabled=1
priority=50
gpgcheck=1
...
baseurl=https://repo.radeon.com/graphics/$ROCM_VERSIONS/el/$VERSION_ID/main/x86_64/
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
