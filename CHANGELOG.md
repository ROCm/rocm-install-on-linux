...
## (Unreleased) Offline Installer Creator v1.0.10

### Added

- Add ROCm 6.4.2 support for Ubuntu 20.04, 22.04, 24.04, SUSE 15.6, RHEL 8.10, 9.4, 9.6, Oracle Linux 8.10 and 9.6 and their ctests.
