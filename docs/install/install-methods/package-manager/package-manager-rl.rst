...
For information about the AMDGPU driver installation, see the `Rocky Linux native installation <https://instinct.docs.amd.com/projects/amdgpu-docs/en/docs-|udev_amdgpu_version|/install/detailed-install/package-manager/package-manager-rl.html>`_ in the AMD Instinct Data Center GPU Documentation.
