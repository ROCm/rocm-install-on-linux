...
* ``<creator-package>``: The ROCm Offline Installer Creator package name, for example, ``rocm-offline-creator_1.0.12.70000-8~22.04.run``.
...
.. code-block:: shell
   ...
   wget https://repo.radeon.com/rocm/installer/rocm-linux-install-offline/rocm-rel-7.0/ubuntu/22.04/rocm-offline-creator_1.0.12.70000-8~22.04.run
...
.. code-block:: shell
   ...
   bash ./rocm-offline-creator_1.0.12.70000-8~22.04.run <options>
...
.. code-block:: shell
   ...
   bash ./rocm-offline-creator_1.0.12.70000-8~22.04.run prompt
