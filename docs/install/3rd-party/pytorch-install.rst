...
.. tab-set::
   ...
   .. tab-item:: PyTorch 2.7.1 (preview)

      .. caution::

         This is an untested development Docker using ROCm 6.4.1 for preview
         purposes. See PyTorch 2.6.0 for the latest stable ``rocm/pytorch``
         Docker release.
      ...
      .. tab-set::
         ...
         .. tab-item:: Python 3.12
            ...
            .. list-table::
               ...
               * - 24.04
                 - `1.7.0 <https://github.com/ROCm/apex/tree/release/1.7.0>`__
            ...
            on `Docker Hub
            <https://hub.docker.com/layers/rocm/pytorch/rocm6.4.1_ubuntu24.04_py3.12_pytorch_release_2.7.1/images/sha256-a416f50f431ae3063c179d11a5f933d9f0e9d35692c66502a439e8dbc85767cc>`__.
