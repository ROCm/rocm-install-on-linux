...
.. caution::
	...
	This topic does not reflect the latest version of Ray on ROCm documentation. See :doc:`../ray-install` for the latest version.
...
* :ref:`using-docker-with-ray-pre-installed-v258` **(recommended)**
* :ref:`build-ray-rocm-docker-image-v258`
* :ref:`install-rocm-ray-bare-metal-v258`
* :ref:`build-rocm-ray-from-source-v258`

.. _using-docker-with-ray-pre-installed-v258:
...
.. _build-ray-rocm-docker-image-v258:
...
.. _build-rocm-ray-from-source-v258:
