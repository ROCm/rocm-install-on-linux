...
.. note::
   ...
   instructions on ROCm 7.0.0, 6.4.3, 6.4.2 and 6.4.1.
...
* :ref:`using-docker-with-llama-cpp-pre-installed-v259` **(recommended)**
* :ref:`build-llama-cpp-docker-image-v259`

.. _using-docker-with-llama-cpp-pre-installed-v259:
...
.. important::
   ...
   See the available tags on `Docker Hub <https://hub.docker.com/r/rocm/llama.cpp/tags>`_ and see :ref:`docker image support <llama-cpp-docker-support-v259>` below.
...
.. _llama-cpp-docker-support-v259:
...
.. _build-llama-cpp-docker-image-v259:
