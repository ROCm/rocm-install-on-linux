...
* :ref:`using-docker-with-llama-cpp-pre-installed-v258` **(recommended)**
* :ref:`build-llama-cpp-docker-image-v258`

.. _using-docker-with-llama-cpp-pre-installed-v258:
...
.. important::
   ...
   See the available tags on `Docker Hub <https://hub.docker.com/r/rocm/llama.cpp/tags>`_ and see :ref:`docker image support <llama-cpp-docker-support-v258>` below.
...
.. _llama-cpp-docker-support-v258:
...
.. _build-llama-cpp-docker-image-v258:
