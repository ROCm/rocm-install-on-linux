...
1. Pull the ROCm Ubuntu Docker image. For example, use the following command to pull the ROCm Ubuntu image:
   ...
   .. code-block:: bash
      ...
      docker pull rocm/dev-ubuntu-22.04:7.0.0-complete
...
2. Launch the Docker container. After pulling the image, launch a container using this command:
   ...
   .. code-block:: bash
      ...
      docker run -it \
          ...
          -v $(pwd):/jax_dir \
          --name rocm_jax \
          rocm/dev-ubuntu-22.04:7.0.0-complete /bin/bash
...
2. Build ``manylinux`` wheels.
   ...
   .. code-block:: bash
    ...
    python3 build/ci_build --compiler=clang --python-versions="3.10, 3.11, 3.12, 3.13" --rocm-version=7.0.0 dist_wheels
...
5. Create Docker image.
   ...
   .. code-block:: bash
    ...
    python3 build/ci_build --rocm-version=7.0.0 build_dockers --filter=ubu22
