...
For hardware, software, and third-party framework compatibility between ROCm and llama.cpp,
see the following resources:

* :ref:`system-requirements`
* :doc:`rocm:compatibility/ml-compatibility/llama-cpp-compatibility`
...
1. Download your required public `llama.cpp Docker image <https://hub.docker.com/r/rocm/llama.cpp/tags>`_
