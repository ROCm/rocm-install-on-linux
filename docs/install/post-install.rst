...
.. code-block:: shell
   ...
   export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:+$LD_LIBRARY_PATH:}/opt/rocm-|rocm_directory_version|/lib
   ...
   .. tab-item:: amd-smi
      ...
      **Example output:**
      ...
      .. code-block:: bash
          ...
          AMDSMI Tool: 26.2.2+97f5574fe2 | AMDSMI Library version: 26.2.2 | ROCm version: 7.2.4 | amdgpu version: 6.16.13 | hsmp version: N/A
