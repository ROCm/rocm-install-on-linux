...
For detailed guidance, see `Installation via native package manager <https://instinct.docs.amd.com/projects/amdgpu-docs/en/docs-30.10/install/package-manager-index.html>`_ for AMD GPU installation and :doc:`Detailed install <detailed-install>` for ROCm installation.
