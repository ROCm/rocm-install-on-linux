...
rocm_version = '6.3.3'
rocm_multi_versions = '6.3.3 6.3.2' # in 6.3, the folder names on repo.radeon.com use 6.3 for minor releases
rocm_multi_versions_package_versions = '6.3.3 6.3.2' # however, in multi, the packages use 6.3.0
...
amdgpu_install_version = '6.3.60303-1' # version in https://repo.radeon.com/amdgpu-install/6.0.2/ubuntu/jammy/
